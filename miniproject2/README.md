...
- MQTT Subscriver : MQTT 데이터 수신 및 DB 저장
...
- [비전센서](https://www.devicemart.co.kr/goods/view?no=15548729) : AI 접목 카메모듈
    - 긁힘, 오여므 결함, 조립 오류 탐지

- 2019년도 학생 작품 영상 - https://www.youtube.com/watch?v=qo5e_HCUAl8
- 유튜브에서 sorting machine로 검색

#### 양품/불량품 선별용 모터 장비
- [컨베이터벨트]() - 선별을 위한 기반 인프라
- [서브모터]() - 가장 저렵하게 분류가능
- [푸시모터]() - 앞쪽으로 밀어내어서 분류
- [에어실린더]() - 
- []
