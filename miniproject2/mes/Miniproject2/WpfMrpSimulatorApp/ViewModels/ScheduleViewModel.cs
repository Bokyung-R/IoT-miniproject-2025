...
namespace WpfMrpSimulatorApp.ViewModels
{
    public partial class ScheduleViewModel : ObservableObject
    {
        ...
        private ObservableCollection<Setting> _setting;
        ...
        public Setting SelectedSetting
        {
            ...
            set
            {
                ...
                if (_selectedSetting != null)   // 삭제후에는 _selectedSetting 자체가 null이 됨
                {
            ...
            try
            {
                ...
                using (MySqlConnection conn = new MySqlConnection(Common.CONNSTR))
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        // modDt는 최추에 입력 후 항상 null. NULL타입 체크 필수
        ...
        public async Task SaveData()
        {
            ...
            try
            {
                ...
                using (MySqlConnection conn = new MySqlConnection(Common.CONNSTR))
                {
                    ...
                    {
                        await this.dialogCoordinator.ShowMessageAsync(this, "기본설정 저장", "데이터 저장에 실패했습니다.");
                    }
                }
            }
            catch (Exception ex)
