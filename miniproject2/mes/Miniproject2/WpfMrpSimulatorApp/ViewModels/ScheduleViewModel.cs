...
namespace WpfMrpSimulatorApp.ViewModels
{
    public partial class ScheduleViewModel : ObservableObject
    {
        ...
        private void InitComboboxes()
        {
            ...
            {
                var settings = db.Settings.Where(s=>s.BasicCode.StartsWith("PLT")).ToList();
                PlantCodes = new ObservableCollection<Setting>(settings);
        ...
        public async Task SaveData()
        {
            ...
            try
            {
                ...
                using (var db = new IoTDbContext())
                {
                    ...
                    {
                        schedule.RegDt = DateTime.Now;  // 등록일 현재 일자로
        ...
        public async Task RemoveData()
        {
            ...
            try
            {
                ...
                await this.dialogCoordinator.ShowMessageAsync(this, "공정계획 삭제", "데이터 삭제되었습니다.");
